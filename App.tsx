        ...
        <button
            ...
            className={`
                ...
                ${active
                    ...
                    : 'text-black dark:text-black hover:bg-gray-100 dark:hover:bg-white/5 hover:text-black dark:hover:text-white'
                }
            `}
        >
                        ...
                        <div className="relative" ref={profileMenuRef}>
                            ...
                            {isProfileOpen && (
                                <div className="absolute right-0 top-full mt-4 w-72 bg-white dark:bg-[#1E1E1E] rounded-xl shadow-2xl border border-gray-100 dark:border-white/5 overflow-hidden z-50 transform origin-top-right animate-in fade-in zoom-in-95 duration-200">
                                    ...
                                    <div className="p-2">
                                        <button onClick={() => { setMode(AppMode.PROFILE); setIsProfileOpen(false); }} className="w-full text-left px-4 py-3 text-sm font-medium text-black dark:text-gray-50 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg flex items-center gap-3 transition-colors">
                                            <AccountCircleIcon fontSize="small" className="text-black" />
                                            Seu Perfil
                                        </button>
                                        <button onClick={() => { setMode(AppMode.DASHBOARD); setIsProfileOpen(false); }} className="w-full text-left px-4 py-3 text-sm font-medium text-black dark:text-gray-50 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg flex items-center gap-3 transition-colors">
