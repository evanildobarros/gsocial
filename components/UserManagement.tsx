...
export const UserManagement: React.FC<UserManagementProps> = ({ onAddUser }) => {
    ...
    const getRoleChip = (role: UserRole) => {
        switch (role) {
            ...
            case 'user': return (
                <span className="inline-flex items-center gap-1 bg-gray-100 dark:bg-gray-800 text-black dark:text-white px-2 py-1 rounded-lg text-xs font-black uppercase tracking-wide border border-gray-200 dark:border-gray-700">
                                                ...
                                                <>
                                                    ...
                                                    <div className="absolute right-8 top-12 z-20 bg-white dark:bg-zinc-800 border border-gray-100 dark:border-white/10 rounded-xl shadow-xl w-48 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                                                        <button
                                                            ...
                                                            className="w-full text-left px-4 py-3 text-sm font-bold text-black dark:text-white hover:bg-gray-50 dark:hover:bg-white/5 flex items-center gap-2"
                                                        >
