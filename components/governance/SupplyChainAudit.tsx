    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
                        ...
                        {filteredSuppliers.map((supplier) => {
                            ...
                            return (
                                <tr key={supplier.id} className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-black dark:text-gray-100">{supplier.category}</td>
            ...
            <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-3xl border border-gray-200 dark:border-white/10">
                <h4 className="font-bold text-black dark:text-gray-50 text-xs uppercase mb-2">Lógica de Bloqueio Automático</h4>
