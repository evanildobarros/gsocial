    ...
    return (
        <div className="w-full space-y-8 animate-in fade-in duration-700 pb-20">
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 px-2">
                <div>
                    <div className="text-[11px] font-black text-purple-600 uppercase tracking-widest mb-1 flex items-center gap-2">
                                    ...
                                    <div className="p-6 space-y-4">
                                        <div className="flex justify-between items-start">
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <span className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Criticidade: {a.criticality}</span>
                                            </div>
                                        ...
                                        <div className="flex justify-between items-center pt-4 border-t border-gray-50 dark:border-white/5">
                                            <span className="text-[11px] font-bold text-gray-400">DUE DILIGENCE 2026</span>
                        ...
                        <div className="bg-white dark:bg-[#1C1C1C] rounded-3xl border border-gray-200 dark:border-white/5 p-8 space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-1">Razão Social / Nome Fantasia</label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-1">Nível de Criticidade Estratégica</label>
                                    <div className="flex gap-2">
                                        {CRITICALITY_LEVELS.map(level => (
                                            <button
                                                key={level.id}
                                                onClick={() => setCriticality(level.id)}
                                                className={`flex-1 p-3 rounded-2xl border text-[11px] font-black uppercase transition-all ${criticality === level.id ? 'bg-purple-600 border-purple-600 text-white shadow-lg' : 'bg-transparent border-gray-100 text-gray-400 dark:border-white/5 dark:text-gray-400'}`}
                                            >
                                                {level.label}
                                            </button>
                                        ))}
                                        ...
                                        {q.evidenceRequired && (
                                            <div className="p-4 bg-purple-50/50 dark:bg-purple-900/10 rounded-2xl border border-dashed border-purple-200 flex justify-between items-center">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <span className="text-[11px] font-black text-purple-600 uppercase tracking-widest block">Provas de Vida Obrigatórias</span>
                                                ...
                                                <button className="text-[11px] font-black text-purple-600 uppercase hover:underline">Fazer Upload</button>
                                            </div>
                                        )}
                                    </div>
                                ))}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`p-8 rounded-3xl border shadow-2xl animate-in zoom-in-95 duration-500 ${currentRisk.color} border-current border-opacity-20`}>
                             <div className="flex items-center gap-2 mb-6 text-purple-600">
                                ...
                                <span className="text-[11px] font-black uppercase tracking-widest opacity-70">Matriz de Integridade (GRC)</span>
                             </div>

                             <div className="space-y-6">
                                <div>
                                    <h4 className="text-xl font-black leading-tight uppercase tracking-tight">{currentRisk.badge}</h4>
                                    <p className="text-[11px] font-bold opacity-60 uppercase mt-1">Due Diligence de Terceiros</p>
                                </div>
                                ...
                                <div className="p-5 bg-white/40 dark:bg-black/20 rounded-2xl border border-current border-opacity-10 space-y-3">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="space-y-1">
                                            <span className="text-[11px] font-black uppercase opacity-70">RECOMENDAÇÃO GRC</span>
                        ...
                        <div className="bg-zinc-50 dark:bg-white/5 p-6 rounded-3xl border border-gray-200 dark:border-white/10">
                             <div className="flex items-center gap-2 mb-4 text-gray-700 dark:text-gray-300">
                                <Zap size={16} />
                                <span className="text-[11px] font-black uppercase tracking-widest">Mapas de Risco Corporativo</span>
                             </div>
