                ...
                <div className="bg-white dark:bg-[#1C1C1C] p-6 rounded-3xl border border-gray-200 dark:border-white/5 shadow-sm h-full">
                    ...
                    <div className="space-y-8">
                        <div>
                            <div className="flex justify-between mb-2">
                                <label className="text-xs font-bold text-black dark:text-gray-100">Crescimento de Carga (%)</label>
                            ...
                            />
                            <p className="text-[10px] text-black mt-1">Impacta emissões e risco social (tráfego).</p>
                        </div>

                        <div>
                            <div className="flex justify-between mb-2">
                                <label className="text-xs font-bold text-black dark:text-gray-100">Adoção Renovável (%)</label>
                            ...
                            />
                            <p className="text-[10px] text-black mt-1">Fator de redução direta de Escopo 2.</p>
                        </div>

                        <div>
                            <div className="flex justify-between mb-2">
                                <label className="text-xs font-bold text-black dark:text-gray-100">Investimento Social (% Budget)</label>
                            ...
                            />
                            <p className="text-[10px] text-black mt-1">Mitiga riscos de conflito comunitário.</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100 dark:border-white/5">
                        <button
                            ...
                            className="w-full py-2.5 border border-gray-200 dark:border-white/10 rounded-lg text-black dark:text-black font-medium text-sm hover:bg-gray-50 dark:hover:bg-white/5 transition-colors flex items-center justify-center gap-2"
                        >
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white dark:bg-[#1C1C1C] p-6 rounded-3xl border border-gray-200 dark:border-white/5 shadow-sm">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                ...
                                <div className="flex items-center gap-4 mt-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-black">Histórico (6 meses)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                            ...
                            <div className="text-right">
                                <p className="text-[10px] text-black uppercase tracking-widest font-bold">Forecast 2026</p>
                                ...
                                <p className="text-xs text-black">tons CO2e</p>
                            </div>
                        </div>
                            ...
                            {simulationData.chartData.map((val, idx) => {
                                ...
                                return (
                                    <div key={idx} className="w-full flex flex-col items-center group relative h-full justify-end">
                                        ...
                                        {/* X-Axis Label */}
                                        <span className="text-[9px] text-black mt-2 font-mono">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white dark:bg-[#1C1C1C] p-5 rounded-3xl border border-gray-200 dark:border-white/5">
                            <h4 className="font-bold text-black dark:text-gray-50 text-sm mb-3 flex items-center gap-2">
                                <Zap className="w-4 h-4 text-yellow-500" />
                                Insights Automáticos
                            </h4>
                            <ul className="space-y-2">
                                {cargoGrowth > 10 && (
                                    <li className="text-xs text-black dark:text-black flex gap-2">
