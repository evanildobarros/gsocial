        ...
        <div className="rounded-3xl border border-gray-200 dark:border-white/5 shadow-sm p-6 bg-white dark:bg-[#1C1C1C]">
            ...
            <div className="space-y-3">
                <div className="flex justify-between items-center text-xs">
                    ...
                    <span className="font-black text-black dark:text-gray-50 truncate max-w-[150px]">{selectedCommunity?.community_name || '-'}</span>
                </div>
                <div className="flex justify-between items-center text-xs">
                ...
                <div className="flex justify-between items-center text-xs">
                    ...
                    <span className="font-black text-black dark:text-gray-50">{selectedCommunity?.settlement_type || '-'}</span>
                </div>
                <div className="flex justify-between items-center text-xs">
