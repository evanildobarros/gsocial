...
const calculateRiskHeatmap = (
    ...
    // 3. Fator de Mitigação: Ações Sociais (Índices Positivos indicados pelo usuário)
    // Cada ação social estruturante reduz o risco
    riskScore -= priorityNeeds.length * 1.0;

    // 4. Fator de Mitigação: Relacionamento Empreendedor
    ...
    // 5. Output do Diagnóstico (Dashboard)
    if (riskScore >= 7) {
        return {
            level: 'CRÍTICO',
    ...
    return (
        <div className="flex gap-1">
            {[1, 2, 3, 4, 5].map((star) => (
                ...
                >
                    <Star
                        className={`w-${readOnly ? '3' : '6'} h-${readOnly ? '3' : '6'} ${star <= value ? 'text-amber-400 fill-amber-400' : 'text-gray-300 dark:text-black'}`}
                    />
                </button>
            ))}
        </div>
    ...
    return (
        <div className="w-full p-4 space-y-8 animate-in fade-in duration-700 pb-20">
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <div className="text-[11px] font-black text-black uppercase tracking-widest mb-1">
                    ...
                    <h1 className="text-2xl font-black text-black dark:text-white tracking-tighter flex items-center gap-2">
                        {viewMode === 'list' ? 'Gestão de Territórios & Risco' : 'Cadastro de Comunidade Local'}
                    </h1>
                            ...
                            <div className="p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            <p className="text-[11px] font-black text-black uppercase tracking-widest mb-3">Perfil do Povoado</p>
                                            <div className="flex flex-wrap gap-2">
                        ...
                        <div className="bg-white dark:bg-[#1C1C1C] rounded-3xl border border-gray-200 dark:border-white/5 overflow-hidden">
                            <div className="p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div>
                                        <p className="text-[11px] font-black uppercase tracking-widest text-black mb-3">Abastecimento de Água (Índice de Vulnerabilidade)</p>
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <p className="text-[11px] font-black uppercase tracking-widest text-black mb-3">Esgotamento Sanitário</p>
                                            <div className="space-y-2">
                            ...
                            <div className="p-8">
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-3">
                                        <label className="text-xs font-bold text-black uppercase ml-1 block">Impactos Percebidos do Porto (Índices Negativos)</label>
                                        <MultiSelectChips
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-xs font-bold text-black uppercase ml-1 block">Ações Sociais & S-ROI (Índices Positivos)</label>
                                        <MultiSelectChips
                                        ...
                                        {priorityNeeds.length > 0 && (
                                            <div className="mt-4 p-4 rounded-3xl border border-dashed border-gray-200 dark:border-white/10 bg-blue-50/50 dark:bg-white/5 flex items-center justify-between">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <span className="text-[11px] font-black text-black uppercase tracking-widest block">Comprovante de S-ROI</span>
                                    ...
                                    <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-3xl border border-gray-100 dark:border-white/10">
                                        <p className="text-[11px] font-black text-black uppercase tracking-widest mb-4">Nível de Relacionamento Empreendedor (EMAP)</p>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-sm font-bold text-black">
                                                ...
                                                {relationshipLevel === 5 && 'Excelente / Parceria'}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white dark:bg-[#1C1C1C] rounded-3xl border border-gray-200 dark:border-white/5 shadow-sm p-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center text-xs">
                                    ...
                                    <span className="font-black text-black dark:text-white truncate max-w-[150px]">{communityName || '-'}</span>
                                </div>
                                <div className="flex justify-between items-center text-xs">
                                ...
                                <div className="flex justify-between items-center text-xs">
                                    ...
                                    <span className="font-black text-black dark:text-white">{settlementType || '-'}</span>
                                </div>
                                <div className="flex justify-between items-center text-xs">
