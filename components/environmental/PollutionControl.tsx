    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-white p-8 rounded-[2.5rem] border-2 border-red-50 shadow-2xl shadow-red-900/5 flex flex-col justify-between min-h-[400px]">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Air Quality */}
                        <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-blue-900/5 space-y-6">
                        ...
                        {/* Waste Management */}
                        <div className="bg-gray-900 p-8 rounded-[2.5rem] text-white space-y-6 overflow-hidden relative">
                            ...
                            <div className="relative z-10 space-y-6">
                                ...
                                <button className="w-full py-3 bg-white text-gray-900 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-gray-200 transition-all">
