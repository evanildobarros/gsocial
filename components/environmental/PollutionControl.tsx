    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-white p-8 rounded-3xl border-2 border-red-50 shadow-2xl shadow-red-900/5 flex flex-col justify-between min-h-[400px]">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Air Quality */}
                        <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl shadow-blue-900/5 space-y-6">
                        ...
                        {/* Waste Management */}
                        <div className="bg-gray-900 p-8 rounded-3xl text-white space-y-6 overflow-hidden relative">
                            <Trash2 className="absolute top-0 right-0 w-32 h-32 text-white/5 -rotate-12 translate-x-8 -translate-y-4" />
                            <div className="relative z-10 space-y-6">
                                <div className="p-3 bg-white/10 rounded-3xl w-fit">
