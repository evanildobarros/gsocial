        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                ...
                <div className="flex gap-3">
                    <button
                        onClick={generatePDF}
                        className="px-4 py-2 rounded-lg border border-gray-300 dark:border-white/10 text-black dark:text-gray-100 font-black text-[11px] hover:bg-gray-50 dark:hover:bg-white/5 transition-colors flex items-center gap-2"
                    >
                ...
                <div className="lg:col-span-3 bg-white dark:bg-[#1C1C1C] rounded-lg border border-gray-200 dark:border-white/5 shadow-sm overflow-hidden">
                    <div className="p-6 border-b border-gray-100 dark:border-white/5 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-sm font-black uppercase tracking-tighter dark:text-gray-100">Histórico de Consumo</h3>
                        </div>
                    </div>
