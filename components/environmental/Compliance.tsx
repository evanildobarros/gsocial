                ...
                <div className="bg-gray-900 p-8 rounded-3xl text-white">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="p-4 bg-white/5 rounded-3xl border border-white/5 flex items-center justify-between group hover:bg-white/10 transition-all cursor-pointer">
