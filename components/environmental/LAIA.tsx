...
export const LAIA: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-700">
            ...
            <div className="bg-white p-4 rounded-3xl border border-gray-100 flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-black">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden">
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center py-20 space-y-4">
                        ...
                        <p className="text-black font-black uppercase tracking-widest text-[10px]">Lendo Matriz LAIA...</p>
                    </div>
                ) : (
                            ...
                            {filteredRecords.map(record => {
                                ...
                                return (
                                    <tr key={record.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-6 font-mono text-[10px] text-black font-bold">
                                        ...
                                        <td className="px-6 py-6 text-right">
                                            <button className="p-2 text-gray-600 hover:text-happiness-1">
