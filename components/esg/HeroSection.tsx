    ...
    <section className="relative h-screen flex items-center overflow-hidden bg-zinc-950 text-white isolate">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full pt-24 pb-12 flex flex-col items-center lg:items-start text-center lg:text-left">
        <div className="max-w-4xl animate-fade-in-up flex flex-col items-center lg:items-start">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-fluid-5xl font-black leading-tight tracking-tighter mb-6 antialiased text-white">
            Transforme a Sustentabilidade <br className="hidden md:block"/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-cyan-300">do seu Negócio</span> <br className="hidden md:block" />
            em Vantagem Competitiva.
          </h1>

          <p className="max-w-2xl text-sm md:text-lg font-medium leading-relaxed text-white/90 mb-8 mx-auto lg:mx-0 px-2 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-16 w-full sm:w-auto">
            <button onClick={onScrollClick} className="px-8 py-3.5 md:py-4 bg-gradient-to-r from-emerald-600 to-cyan-600 text-white font-bold rounded-full hover:scale-105 transition-all shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/50 w-full sm:w-auto">
              Quero meu Diagnóstico ESG Gratuito
            </button>
            <button className="px-8 py-3.5 md:py-4 bg-white/10 text-white font-bold rounded-full hover:bg-white/20 transition-all border border-white/20 w-full sm:w-auto">
              Relatório 2024 (PDF)
            </button>
          </div>
        </div>
