...
export const HeroSection: React.FC<HeroSectionProps> = ({ onScrollClick }) => {
  return (
    <section className="relative h-screen w-full flex items-center bg-[#0a192f] text-white isolate overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full flex flex-col justify-center h-full">
