  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden bg-zinc-950 text-white isolate">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full pt-48 pb-12 flex flex-col items-center lg:items-start text-center lg:text-left">
        <div className="max-w-5xl animate-fade-in-up flex flex-col items-center lg:items-start gap-y-8 mt-8">
          ...
          <p className="max-w-2xl text-sm md:text-lg font-medium leading-relaxed text-white/90 mb-4 mx-auto lg:mx-0 px-2 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12 w-full sm:w-auto">
