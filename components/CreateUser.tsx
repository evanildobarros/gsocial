            ...
            <div className="min-h-[600px] flex items-center justify-center animate-in fade-in zoom-in duration-500">
                <div className="text-center space-y-6 bg-white p-12 rounded-3xl shadow-2xl shadow-happiness-1/10 border border-gray-100 max-w-md w-full">
                    ...
                    <div className="pt-4">
                        <button
                            onClick={onBack}
                            className="bg-gray-900 text-white px-8 py-4 rounded-3xl font-black text-sm uppercase tracking-widest hover:bg-gray-800 transition-all flex items-center gap-2 mx-auto"
                        >
                ...
                <div className="lg:col-span-2">
                    <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                        <div className="p-8 md:p-12 space-y-8">
                            {error && (
                                <div className="bg-red-50 border-2 border-red-100 p-4 rounded-3xl flex items-center gap-3 text-red-600 font-bold text-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-600 group-focus-within:text-happiness-1 transition-colors" />
                                        <input
                                            required
                                            type="text"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-600 group-focus-within:text-happiness-1 transition-colors" />
                                        <input
                                            required
                                            type="email"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <Shield className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-600 group-focus-within:text-happiness-1 transition-colors" />
                                        <select
                                            value={formData.role}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <Key className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-600 group-focus-within:text-happiness-1 transition-colors" />
                                        <input
                                            required
                                        ...
                                        <button
                                            ...
                                            className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-600 hover:text-happiness-1 transition-colors"
                                        >
                            ...
                            <div className="pt-4 flex flex-col sm:flex-row gap-4">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex-1 bg-happiness-1 text-white px-8 py-4 rounded-3xl shadow-xl shadow-happiness-1/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 font-black text-sm uppercase tracking-widest disabled:opacity-50 disabled:hover:scale-100"
                                >
                                    {loading ? (
