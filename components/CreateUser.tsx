    ...
    if (success) {
        return (
            <div className="min-h-[600px] flex items-center justify-center animate-in fade-in zoom-in duration-500">
                <div className="text-center space-y-6 bg-white p-12 rounded-[3rem] shadow-2xl shadow-happiness-1/10 border border-gray-100 max-w-md w-full">
                    ...
                    <div className="pt-4">
                        <button
                            onClick={onBack}
                            className="bg-gray-900 text-white px-8 py-4 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-gray-800 transition-all flex items-center gap-2 mx-auto"
                        >
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="p-8 md:p-12 space-y-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-6 py-4 bg-gray-50 border-2 border-transparent rounded-2xl text-sm font-semibold text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-happiness-1 transition-all outline-none"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <select
                                            ...
                                            className="w-full pl-12 pr-6 py-4 bg-gray-50 border-2 border-transparent rounded-2xl text-sm font-semibold text-gray-900 focus:bg-white focus:border-happiness-1 transition-all outline-none appearance-none cursor-pointer"
                                        >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            placeholder="••••••••"
                                            className="w-full pl-12 pr-12 py-4 bg-gray-50 border-2 border-transparent rounded-2xl text-sm font-semibold text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-happiness-1 transition-all outline-none"
                                        />
                                        <button
                                            type="button"
                            ...
                            <div className="pt-4 flex flex-col sm:flex-row gap-4">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex-1 bg-happiness-1 text-white px-8 py-4 rounded-2xl shadow-xl shadow-happiness-1/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 font-black text-sm uppercase tracking-widest disabled:opacity-50 disabled:hover:scale-100"
                                >
                                    {loading ? (
                ...
                <div className="space-y-6">
                    <div className="bg-[#1C1C1C] p-8 rounded-[2.5rem] relative overflow-hidden group">
