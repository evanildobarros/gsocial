                    ...
                    <div className="space-y-4">
                        ...
                        {!selectedFile ? (
                            ...
                            >
                                ...
                                <p className="text-sm font-bold text-black dark:text-gray-50 mb-1">Arraste e solte ou clique para selecionar</p>
                            ...
                            <div className="bg-green-500/5 dark:bg-green-500/10 rounded-3xl border border-green-500/20 p-5 flex items-center justify-between animate-in zoom-in-95 duration-200">
                                <div className="flex items-center gap-4 truncate">
                                    ...
                                    <div className="truncate">
                                        <p className="text-sm font-black text-black dark:text-gray-50 truncate">{selectedFile.name}</p>
